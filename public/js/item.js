  ...
  methods : {
        getVueItems: function(page){
          this.$http.get('/vueitems?page='+page).then((response) => {
            console.log(33,JSON.parse(response.data).data.pagination);
              this.$set('items', JSON.parse(response.data).data.data);
             this.$set('pagination', JSON.parse(response.data).data.pagination);
          });
        },
        createItem: function(){
